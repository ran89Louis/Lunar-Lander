...
def display_stats():
    ...
    a_str = "acceleration: %.if" %(delta_v * fps)
    f_str = "fuel:  %i" % fuel
...
def display_final():
    final1 = "Game over"
    final2 = "You landed at %.if m/s"  % velocity
    if velocity > -5:
        final3 = "Nice landing!"
    ...
    fi_font = pygame.font.Font(None, 70)
    f1_surf = fi_font.render(final1, 1, (255, 255, 255))
...
while running:
    ...
    if height > 0.01:
         ...
         instruct1 = "Land softly without runing out of fuel"
